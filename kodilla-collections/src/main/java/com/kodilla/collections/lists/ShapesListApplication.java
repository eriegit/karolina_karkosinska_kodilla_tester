...
public class ShapesListApplication {
    public static void main(String[] args) {
        ...
        // Tego typu zapis nazywamy typem generycznym, gdzie typ danych wewnętrznych
        // jest po prostu w ten sposób przekazanym parametrem,
...
//            Square square = shapes.get(n);
        for (Square square : shapes) { // pętla for-each od prawej:
            // iteruj po kolekcji shapes i kolejne jej elem wstawiaj do zmiennej square typu Square
