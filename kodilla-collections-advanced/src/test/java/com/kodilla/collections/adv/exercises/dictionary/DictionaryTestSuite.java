...
class DictionaryTestSuite {
    ...
    public  void testAddWord(){
        //given przygotowujemy dane testowe, obiekt do testowania oraz wszystkie inne rzeczy,
...
//when w tej sekcji z reguły znajduje się tylko jedna linia – jest to wywołanie metody, którą testuje nasz test
    ...
    public void testFindEnglishWords() {
            ...
            // then
            //assertEquals(2, result.size()); sprawdzenie rozmiarów wynikowej kolekcji nie jest wystaarczające
